...
class MediaList(APIView):
    ...
    @swagger_auto_schema(
        manual_parameters=[
            ...
            openapi.Parameter(name='media_type', type=openapi.TYPE_STRING, in_=openapi.IN_QUERY, description='Media type, options: "video", "audio", "image", "pdf"'),
            openapi.Parameter(name='featured', type=openapi.TYPE_STRING, in_=openapi.IN_QUERY, description='Filter by featured status, options: "true", "false", "all"'),
            openapi.Parameter(name='is_reviewed', type=openapi.TYPE_STRING, in_=openapi.IN_QUERY, description='Filter by reviewed status, options: "true", "false", "all"'),
            openapi.Parameter(name='reported', type=openapi.TYPE_STRING, in_=openapi.IN_QUERY, description='Filter by reported status, options: "true", "false", "all"'),
            openapi.Parameter(name='category', type=openapi.TYPE_STRING, in_=openapi.IN_QUERY, description='Filter by category title (contains match)'),
        ],
        tags=['Manage'],
